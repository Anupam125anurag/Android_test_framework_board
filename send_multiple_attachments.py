...
body = f"Hello, Please find the reports of Integrated Android Security test framework {device_name}." \
...
filename="Report_all.txt"
attachment1 = open("/home/idm/Desktop/HDK855/Report_all.txt", "rb")
filename2="cts_results.zip"
attachment2 = open("/home/idm/Desktop/HDK855/cts_results.zip", "rb")
